<%@page import="java.util.HashMap, java.util.List, java.util.Date, org.apache.commons.lang3.StringUtils"%>
<%@page import="com.expense.utils.FormatUtils, com.expense.utils.Props, com.expense.utils.Menus, com.expense.mvc.model.ui.DataKeyUI, com.expense.mvc.model.entity.DataKey"%>
<%
...
<div align="left" style="position: relative; left: 0px; top: 0px;">
	<div align="left" style="position: relative; top: 0px; left: 2px; width: 1362px; height: 42px;">
...
%>
				<td width="10%" align="center" class="menuHL" onclick="javascript:gotoPage('<%= pg.url %>')"><%= pg.name %></td>
<%
		}
	}
%>
...
%> 
								<select id="dataKey" name="dataKey" style="width: 120px;" dojoType="dijit.form.Select" class="dashboardTxt">
<%
...
<%
				if(StringUtils.equalsIgnoreCase(Menus.Page.ENTRY.type, CURR_PAGE)) {
%>
								<div style="position: relative; top: 0px; left: 0px; width: 20px; height: 20px;" title="Go" onclick="changeDataKey()" class="menuDKGo"></div>
<%
				}
%>
									&nbsp;
							...
							<td width="63%" align="center" valign="middle">
								<table width="100%" cellspacing='0' cellpadding='2' border="0">
									<tr height="30" valign="middle">
										<td width="30%" align="center" class="<%= menuCss %>"><%= dkey.getDescription() %></td>
										<td width="50%" align="center" class="<%= menuCss %>"><%= dkey.getStrStartDt() %> - <%= dkey.getStrEndDt() %></td>
										<td width="20%" align="center" class="<%= menuCss %>">
											<div style="position: relative; top: 0px; left: 8px; width: 28px; height: 20px;" class="<%= currencyCss %>"></div>
										</td>
									</tr>
								</table>
							</td>
...
<%
		if(StringUtils.equalsIgnoreCase(Menus.Page.ENTRY.type, CURR_PAGE)) {
%>
					<div style="position: relative; top: 0px; left: 10px; width: 20px; height: 20px;" title="Go" onclick="showUploadDialog()" class="menuUpload"></div>
<%
		}
%>
				</td>
